...
public class DroolsJarScanner implements JarScanner {
    private static final String module = DroolsJarScanner.class.getName();
    ...
    static {
        Debug.logVerbose("============== DroolsJarScanner ==============", module);
        Set<ClassLoader> cls = new HashSet<>();

        ClassLoader cl = DroolsJarScanner.class.getClassLoader();
        while (cl != null) {
            cls.add(cl);
            cl = cl.getParent();
        }
     ...
     */
    private JarScanFilter jarScanFilter = new DroolsJarScanFilter();
